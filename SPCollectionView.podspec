...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SPCollectionView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/sayiwen/SPCollectionView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sayiwen' => 'sayiwen@163.com' }
  s.source           = { :git => 'https://github.com/sayiwen/SPCollectionView.git', :tag => s.version.to_s }
